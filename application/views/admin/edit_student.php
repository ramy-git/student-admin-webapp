      ...
      <div class="box">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <form action="<?php echo base_url();?>Admin/process_update_student" method="post" onsubmit="validateform(event)" >
              <input type="hidden" name="id" value="<?php echo $studentVAL->id; ?>">
            <div class="col-md-6 col-sm-12 form-group">
              <label>Name</label>
              <input type="text" name="name" class="form-control" required="" value="<?php echo $studentVAL->name;?>">
            </div>
            <div class="col-md-6 col-sm-12 form-group">
              <label>Surname</label>
              <input type="text" name="surname" class="form-control" required="" value="<?php echo $studentVAL->surname;?>">
            </div>
            <div class="col-md-6 col-sm-12 form-group">
              ...
              <select class="form-control"  name="class_group" required>
                ...
                foreach ($class_group as $key => $class_groupVAL) { 
                  ...
                  <option  <?php if($class_groupVAL->id==$studentVAL->class_group){ echo ' selected ';  } ?>  value="<?php echo $class_groupVAL->id;?>"><?php echo $class_groupVAL->class_name;?> - <?php echo $class_groupVAL->name;?></option>
                <?php } } } ?>
              </select>
            </div>
            <div class="col-md-6 col-sm-12 form-group">
              <label>Student ID</label>
              <input type="text" name="student_id" class="form-control" value="<?php echo $studentVAL->student_id;?>">
            </div>
            <div class="col-md-6 col-sm-12 form-group">
              <label>Phone</label>
              <input type="text" name="phone" class="form-control" value="<?php echo $studentVAL->phone;?>">
            </div>
            <div class="col-md-6 col-sm-12 form-group">
              <label>Email</label>
              <input type="email" name="email" class="form-control" required="" value="<?php echo $studentVAL->email;?>">
            </div>
            <div class="col-md-6 col-sm-12 form-group">
              <label>Password</label>
              <input type="password"  id="password" name="password" class="form-control" value="<?php echo $studentVAL->password;?>" required="">
            </div>
            <div class="col-md-6 col-sm-12 form-group">
              <label>Confirm Password</label>
              <input type="password" id="cpassword"  class="form-control"  required="" value="<?php echo $studentVAL->password;?>">
            </div>
            <div class="col-md-6 col-sm-12 form-group">
              <label>Verify</label>
              <select class="form-control" name="verify">
                <option  <?php if($studentVAL->verify==0){ echo 'selected '; } ?> value="0">No</option>
                <option <?php if($studentVAL->verify==1){ echo 'selected '; } ?> value="1">Yes</option>
              </select>
            </div>
            <div class="col-md-12 col-sm-12 form-group text-right" id="upload_area">
              ...
              <input type="hidden" name="image" id="form_image" value="<?php echo $studentVAL->image;?>">
